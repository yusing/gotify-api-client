...
DeleteMessagesParams contains all the parameters to send to the API endpoint
	...
	for the delete messages operation.
...
// WithDefaults hydrates default values in the delete messages params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMessagesParams) WithDefaults() *DeleteMessagesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete messages params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteMessagesParams) SetDefaults() {
