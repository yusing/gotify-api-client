...
func (o *DeleteAppReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /application/{id}] deleteApp", response, response.Code())
	}
}
...
func (o *DeleteAppBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /application/{id}][%d] deleteAppBadRequest %s", 400, payload)
}
...
func (o *DeleteAppBadRequest) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *DeleteAppUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /application/{id}][%d] deleteAppUnauthorized %s", 401, payload)
}
...
func (o *DeleteAppUnauthorized) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *DeleteAppForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /application/{id}][%d] deleteAppForbidden %s", 403, payload)
}
...
func (o *DeleteAppForbidden) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *DeleteAppNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /application/{id}][%d] deleteAppNotFound %s", 404, payload)
}
...
func (o *DeleteAppNotFound) GetPayload() *models.Error {
	return o.Payload
}
