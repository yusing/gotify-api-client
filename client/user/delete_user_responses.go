...
func (o *DeleteUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /user/{id}] deleteUser", response, response.Code())
	}
}
...
func (o *DeleteUserBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /user/{id}][%d] deleteUserBadRequest %s", 400, payload)
}
...
func (o *DeleteUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /user/{id}][%d] deleteUserUnauthorized %s", 401, payload)
}
...
func (o *DeleteUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /user/{id}][%d] deleteUserForbidden %s", 403, payload)
}
...
func (o *DeleteUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /user/{id}][%d] deleteUserNotFound %s", 404, payload)
}
